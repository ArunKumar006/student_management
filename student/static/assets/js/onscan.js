	...
	var onScan = {	
		...
		attachTo: function(oDomElement, oOptions) {
			...
			var oDefaults = {
				...
				return onScan.decodeKeyEvent(oEvent)}, // Custom function to decode a keydown event into a character. Must return decoded character or NULL if the given event should not be processed.
